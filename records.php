    ...
    <div id="wrapper">
       ...
       <nav class="navbar navbar-default navbar-static-top" role="navigation" id="navi">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" id="white">Welcome <?php 
  ...
  <div class="container"></div>
    <div class="row">
      <div class="col-sm-3"><!--left col--><!--left col-->
            ...
            <div class="col-sm-3 pull-left" style="padding: 30px;">
            <?php 
               if (isset($_GET["year"])) {
                $year = $_GET["year"];
              }else{
            ...
            <select class="form-control" id="uyear" name="year">
              <option value="<?php echo $latest_year ?>" <?php if($year === $latest_year) echo 'selected="selected"'; ?>> <?php echo $latest_year ?></option>
              <option value="<?php echo $previous_year ?>" <?php if($year=== $previous_year) echo 'selected="selected"'; ?>> <?php echo $previous_year ?></option>
              <option value="<?php echo $earliest_year ?>" <?php if($year=== $earliest_year) echo 'selected="selected"'; ?>> <?php echo $earliest_year ?></option>
            </select>
            ...
            <div class="col-sm-7">
             <ul class="nav nav-tabs" id="myTab" name="quarter">
                <li class="active"><a href="#home" value="1st Quarter" data-toggle="tab">1st Quarter</a></li>
                <li><a href="#second" value="2nd Quarter" data-toggle="tab">2nd Quarter</a></li>
                <li><a href="#third" value="3rd Quarter" data-toggle="tab">3rd Quarter</a></li>
                <li><a href="#fourth" value="4th Quarter" data-toggle="tab">4th Quarter</a></li>
              </ul> 
            ...
            <?php 
                  ...
                  $quarter1 = "SELECT * FROM pft_info WHERE quarter = '1st Quarter' AND serial_no = '$serial_no' and year = $year";
            ...
            <div class="tab-pane" id="second">
              <?php 
                  ...
                  $conn = mysqli_connect('localhost', 'root', '', 'pft');
                  $quarter1 = "SELECT * FROM pft_info WHERE quarter = '2nd Quarter' AND serial_no = '$serial_no'  and year = $year";
                  $result1 = mysqli_query($conn, $quarter1); 
                  $value = mysqli_fetch_array($result1);   
                ?>
              <div class="table">
            ...
            <div class="tab-pane" id="third">
              <?php 
                  $conn = mysqli_connect('localhost', 'root', '', 'pft');
                  $quarter1 = "SELECT * FROM pft_info WHERE quarter = '3rd Quarter' AND serial_no = '$serial_no' and year = $year";
                  $result1 = mysqli_query($conn, $quarter1);
                  $value = mysqli_fetch_array($result1);    
                ?>
              <div class="table">
            ...
            <div class="tab-pane" id="fourth">
              <?php 
                  $conn = mysqli_connect('localhost', 'root', '', 'pft');
                  $quarter1 = "SELECT * FROM pft_info WHERE quarter = '4th Quarter' AND serial_no = '$serial_no' and year = $year";
                  $result1 = mysqli_query($conn, $quarter1);
                  $value = mysqli_fetch_array($result1);
                ?>
              <div class="table">
              ...
              <div class="col-xs-11"></div>
                <div class="form-inline col-xs-11" style="padding-top: 20px; padding-bottom: 50px; text-align: right">
                    <button type="button" class="btn btn-primary btn-lg" id="rit2" onClick="parent.location='<?php if($value1['afpType']==='Officer') echo 'officer.php';if($value1['afpType']==='Enlisted Personnel') echo 'personnel.php'; ?>'"><i class="fa fa-arrow-left"> Go Back</i>
                    </button>
                  </div><!--/col-xs-6-->
            </div><!--/col-sm-7 -->
          </div><!--/row -->
