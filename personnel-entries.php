...
<head>
    ...
    <title>Enlisted Personnel PFT</title>
...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">                    
                        ...
                        <li>
                         ...
                         <li>
                            <a href="personnel-entries.php"  class="active"><i class="fa fa-user"></i> Enlisted Personnel</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Enlisted Personnel's PFT</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
